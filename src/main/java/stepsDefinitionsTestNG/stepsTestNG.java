...
/////////////// SPRAWDZENIE WAITERA
    ...
    public void waiter_Użytkownik_uruchamia_strone_serwisu() {
   //    Properties properties = obj.getProperty();
    ...
    public void waiter_Strona_główna_serwisu_Media_Expert_jest_wyświetlona() {
        String nazwaSerwisu = "Media Expert | Sklep internetowy RTV, AGD, komputery";
        String otrzymanaNazwaSerwisu = driver.getTitle();
        Assert.assertEquals(nazwaSerwisu, otrzymanaNazwaSerwisu);
    }

    @Then("WAITER Użytkownik klika na przycisk Twoje konto")
    public void waiter_Użytkownik_klika_na_przycisk_Twoje_konto() {
     //   czas(3000);
        //driver.findElement(By.linkText("\n" +
        //       "Zaloguj/Zarejestruj")).click();
        //  driver.findElement(By.className("c-menu_linkName")).click();
        WebDriverWait wait = new WebDriverWait(driver, 15);
        WebElement doKlikniecia = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[3]/div/div[5]/div/div/div[3]/div/ul/li[3]/div/a/span[1]")));

        doKlikniecia.click();
    //    driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[5]/div/div/div[3]/div/ul/li[3]/div/a/span[1]")).click();
    }

    @Then("WAITER Użytkownik czeka na załadowanie się strony")
    public void waiter_Użytkownik_czeka_na_załadowanie_się_strony() {
        WebDriverWait wait = new WebDriverWait(driver, 15);
        WebElement przyciskZaloguj = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[3]/div/div[5]/div/div/div[3]/div/ul/li[3]/div/a/span[1]")));
    ...
    @Then("WAITER użytkownik wprowadza w pole login swój login")
    public void waiter_użytkownik_wprowadza_w_pole_login_swój_login() {
        String email = "ddd-ggg-ddd-ggg@wp.pl";
        driver.findElement(By.id("enp_customer_form_login_username")).click();
        driver.findElement(By.id("enp_customer_form_login_username")).sendKeys(email);
        czas(1000);
    ...
    @Then("WAITER użytkownik wprowadza w pole hasło swoje hasło")
    public void waiter_użytkownik_wprowadza_w_pole_hasło_swoje_hasło() {
        String haslo = "5ontoTestowe";
        driver.findElement(By.id("enp_customer_form_login_password")).click();
        driver.findElement(By.id("enp_customer_form_login_password")).sendKeys(haslo);
        czas(1000);
    ...
    @Then("WAITER użytkownik klika na przycisk zaloguj")
    public void waiter_użytkownik_klika_na_przycisk_zaloguj() {
        driver.findElement(By.xpath("/html/body/div[1]/div[7]/div/div/div[1]/div[1]/div[2]/form/div[4]/div/input")).click();
    }

    @Then("WAITER Strona powitalna jest wyświetlona")
    public void waiter_Strona_powitalna_jest_wyświetlona() {
        czas(5000);
        String wynikLogowania = driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[5]/div/div/div[3]/div/ul/li[3]/p/span[1]")).getText();
    ...
    @Then("WAITER Użytkownik wpisuje szukany produkt w wyszukiwarke")
    public void waiter_Użytkownik_wpisuje_szukany_produkt_w_wyszukiwarke() {
        String produkt = "Smartfon APPLE iPhone 11 Pro Max 64GB Srebrny";
        driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[5]/div/div/div[2]/div/div[1]/div[1]/form/input")).sendKeys(produkt);

    }

    @Then("WAITER Użytkownik czeka na znalezienie produktu")
    public void waiter_Użytkownik_czeka_na_znalezienie_produktu() {
       // czas(6000);
        WebDriverWait wait = new WebDriverWait(driver, 15);
        WebElement bb = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[3]/div/div[5]/div/div/div[2]/div/div[2]/div[2]/div[1]/div")));
    }

    @Then("WAITER Użytkownik klika na znaleziony produkt")
    public void waiter_Użytkownik_klika_na_znaleziony_produkt() {
        driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[5]/div/div/div[2]/div/div[2]/div[2]/div[1]/div")).click();
        czas(3000);
    }

    @Then("WAITER Weryfikacja tytulu strony z wyszukanym produktem")
    public void waiter_Weryfikacja_tytulu_strony_z_wyszukanym_produktem() {
        String spodziewanyTytulStrony = "APPLE iPhone 11 Pro Max 64GB Srebrny Smartfon - ceny i opinie w Media Expert";
        String tytulTejStrony = driver.getTitle();
        Assert.assertEquals(spodziewanyTytulStrony, tytulTejStrony);
    }

    @Then("WAITER Użytkownik dodaje produkt do koszyka")
    public void waiter_Użytkownik_dodaje_produkt_do_koszyka() {
        WebDriverWait wait = new WebDriverWait(driver, 15);


       // WebElement b1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[15]/div[1]/div/div[2]/div/div/div[3]/div[4]/div[1]/div[2]/a")));
     ...
     //   WebElement bb3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[9]/div/form/div[2]/div[1]/div[3]/div/div/div[2]/button[2]/span")));
    ...
    //    WebElement b3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"preCart\"]/div/div/div/div/div[2]/div[3]/div/a[1]")));
    //    b3.click();
    ...
    @Then("WAITER Test nr piec zakonczony")
    public void waiter_Test_nr_piec_zakonczony() {
        driver.close();
    }


/////////////// KONIEC SPRAWDZANIA WAITERA
